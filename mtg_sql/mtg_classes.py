...
"""MtgCards and MtgFaceCards are the only ones that are getting any use so far.. the others are placeholders for now """


class MtgCards:
    def __init__(self, name, layout, clr_id, mana_cost, cmc, c_type, keywords, is_legendary, has_etb, has_ramp, 
...
class MtgFaceCards:
    def __init__(self, name, layout, flipname, clr_id, face1_cost, face2_cost, face1_cmc, face2_cmc, face1_type, 
                 face2_type, face1_keywords, face2_keywords, is_legendary, face1_etb, face2_etb, face1_ramp, 
                 face2_ramp, face1_draw, face2_draw, face1_target, face2_target, face1_wipe, face2_wipe, 
                 face1_activated, face2_activated, face1_triggered, face2_triggered, face1_image_url, face2_image_url, 
                 face1_oracle_text, face2_oracle_text):
        self.name = name
        self.layout = layout
        ...
        self.face1_image_url = face1_image_url
...
class MtgColours:
    ...
    def get_clr_id(self, manastring):
        clr_id = ""
        if 'W' in manastring:
            clr_id = clr_id + 'W'
        if 'U' in manastring:
...
# # class MTG_Art_Ench:
# #     """the MtgCards class is already tracking whether this card is for Ramp, Draw, removal,etc purposes, description
